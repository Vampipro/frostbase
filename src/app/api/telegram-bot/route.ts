...
// Токен береться ЛИШЕ зі змінної середовища Vercel (Project Settings → Environment Variables → TELEGRAM_BOT_TOKEN).
// У файлі/репозиторії токена немає — його не видно на GitHub і його не потрібно комітити.
